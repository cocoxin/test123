$(document).ready(function() {
	...
	$('#sms_list').datagrid({
		...
		{title:'发送结果',field:'sms_result',sortable:true,width:120,align:'center',formatter:function(value,rowData,rowIndex){
			...
			{
				return "<a href='javascript:;' onclick='resend_sms("+rowData.sms_id+")' title='重新发送'>已发送</a>";
			}
			else
			{
				return "<a href='javascript:;' onclick='resend_sms("+rowData.sms_id+")' title='重新发送'>失败</a>";
			}
		}},
