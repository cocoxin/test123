...
class Sms_model extends CI_Model
{
    ...
    private function _send_sms($vcc_id, $vcc_code = '', $ag_id, $receiver_phone, $sms_contents, $send_time = '', $client_sms_id, $signature)
    {
        ...
        //判断内容中是否存在签名
        if (!empty($signature) && strstr($sms_contents, $signature)) {
     ...
     * @return object responce
     */
    public function get_sms_statistics($page = 1, $limit = 10, $sort = null, $order = null, $where = null)
    {

        $select = array('user_id', 'user_name', "sum(IF(user_id,1,0)) as active_send_num", "sum(IF(sms_result=1,1,0)) as active_success_num");
